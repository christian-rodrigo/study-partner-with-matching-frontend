...
import type { Conversation, Course, LearningPlace, User } from './lib/types';
...
function App() {
  ...
  const refreshConversations = async () => {
    ...
    if (activeConversation) {
      const latest = data.find((item) => item.id === activeConversation.id) || activeConversation;
      ...
      case 'chat':
        return (
          <ChatPage
            ...
            onPickConversation={setActiveConversation}
  ...
  }, [activeConversation, conversations, courses, places, user, view]);
